<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/CityCore.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="CityCore.Modules.Projects.List" %>
            ...
            <ul id="sidemenu" class="sidebar-nav">
                ...
                <li>
                    <a class="accordion-toggle collapsed toggle-switch" data-toggle="collapse" href="#submenu-2">
                        <span class="sidebar-title">Projects List</span>
                        <b class="caret"></b>
                    </a>

                    <ul id="submenu-2" class="panel-collapse collapse panel-switch" role="menu">
                        <li><a href="List.aspx?Status=Active">Active Projects</a></li>
                        <li><a href="List.aspx?Status=Done">Full-done Projects</a></li>
                        <li><a href="List.aspx?Status=Holding">Holding Projects</a></li>
                        <li><a href="List.aspx?Status=Vacant">Vacant Projects</a></li>
                        <li><a href="List.aspx">All Projects</a></li>
                    </ul>
                </li>
            </ul>
        </aside>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href='/Projects/<%# Eval("ID") %>' class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
